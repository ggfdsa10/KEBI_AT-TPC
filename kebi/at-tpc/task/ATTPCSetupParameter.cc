...
void ATTPCSetupParameter::GetGasParameters()
{
  ...
  if(detMatName == "4He") {
    ...
    Double_t fBAt0Coef2 = (0.170081 +0.0131659 +8.15e-7*parEfield)*10/TMath::Sqrt(10); //[mm/sqrt(mm)]
    Double_t fTDiff = (fBfieldCoef1 + fBfieldCoef2*parEfield + fBfieldCoef3*TMath::Power(parEfield,2) + fBfieldCoef4*TMath::Power(parEfield,3))*10/TMath::Sqrt(10); //[mm/sqrt(mm)]
  } 
}
