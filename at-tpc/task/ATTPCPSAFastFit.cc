#include "ATTPCPSAFastFit.hh"

ClassImp(ATTPCPSAFastFit)

ATTPCPSAFastFit::ATTPCPSAFastFit()
: KBPulseGenerator()
{
  Init();
}

ATTPCPSAFastFit::ATTPCPSAFastFit(TString fileName)
: KBPulseGenerator(fileName)
{
  Init();
}

void ATTPCPSAFastFit::Init()
{
...
void 
ATTPCPSAFastFit::AnalyzeChannel(Double_t *buffer, vector<KBChannelHit> *hitArray, vector<vector<pair<double, double>>> *TBArray)
{
  Double_t adc[512] = {0};
...
Bool_t
ATTPCPSAFastFit::FindPeak(Double_t *adc, 
                          Int_t &tbPointer,
                          Int_t &tbStartOfPulse)
{
...
Bool_t
ATTPCPSAFastFit::FitPulse(Double_t *adc, 
                          Int_t tbStartOfPulse,
                          Int_t tbPeak,
                       Double_t &tbHit, 
                       Double_t &amplitude,
...
void 
ATTPCPSAFastFit::LSFitPulse(Double_t *buffer,
...
Bool_t
ATTPCPSAFastFit::TestPulse(Double_t *adc, 
                        Double_t tbHitPre,
