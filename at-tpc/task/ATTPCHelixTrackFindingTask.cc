#include "KBRun.hh"
#include "ATTPCHelixTrackFindingTask.hh"

#include <iostream>

// #define DEBUG_STEP

ClassImp(ATTPCHelixTrackFindingTask)

bool ATTPCHelixTrackFindingTask::Init()
{
...
void ATTPCHelixTrackFindingTask::Exec(Option_t*)
{
  fNextStep = StepNo::kStepInitArray;
  while (ExecStep()) {}
}

bool ATTPCHelixTrackFindingTask::ExecStep()
{
...
bool ATTPCHelixTrackFindingTask::ExecStepUptoTrackNum(Int_t numTracks)
{
...
int ATTPCHelixTrackFindingTask::StepInitArray()
{
#ifdef DEBUG_STEP
...
int ATTPCHelixTrackFindingTask::StepNewTrack()
{
#ifdef DEBUG_STEP
...
int ATTPCHelixTrackFindingTask::StepRemoveTrack()
{
#ifdef DEBUG_STEP
...
int ATTPCHelixTrackFindingTask::StepInitTrack()
{
#ifdef DEBUG_STEP
...
int ATTPCHelixTrackFindingTask::StepInitTrackAddHit()
{
#ifdef DEBUG_STEP
...
int ATTPCHelixTrackFindingTask::StepContinuum()
{ 
#ifdef DEBUG_STEP
...
int ATTPCHelixTrackFindingTask::StepContinuumAddHit()
{
#ifdef DEBUG_STEP
...
int ATTPCHelixTrackFindingTask::StepExtrapolation()
{ 
#ifdef DEBUG_STEP
...
int ATTPCHelixTrackFindingTask::StepExtrapolationAddHit()
{
#ifdef DEBUG_STEP
...
int ATTPCHelixTrackFindingTask::StepConfirmation()
{
#ifdef DEBUG_STEP
...
int ATTPCHelixTrackFindingTask::StepFinalizeTrack()
{
  auto trackHits = fCurrentTrack -> GetHitArray();
...
int ATTPCHelixTrackFindingTask::StepNextPhase()
{
  if (fPhaseIndex==0) {
    fPhaseIndex = 1;
...
int ATTPCHelixTrackFindingTask::StepEndEvent()
{
...
void ATTPCHelixTrackFindingTask::ReturnBadHitsToPadPlane()
{
...
double ATTPCHelixTrackFindingTask::CorrelateHitWithTrackCandidate(KBHelixTrack *track, KBTpcHit *hit)
{
#ifdef DEBUG_STEP
...
double ATTPCHelixTrackFindingTask::CorrelateHitWithTrack(KBHelixTrack *track, KBTpcHit *hit, Double_t rScale)
{
...
bool ATTPCHelixTrackFindingTask::BuildAndConfirmTrack(KBHelixTrack *track, bool &tailToHead)
{
...
bool ATTPCHelixTrackFindingTask::AutoBuildByExtrapolation(KBHelixTrack *track, bool &buildHead, Double_t &extrapolationLength)
{
  if (track -> GetNumHits() < fCutMinNumHitsFinalTrack)
    return false;
...
bool ATTPCHelixTrackFindingTask::AutoBuildAtPosition(KBHelixTrack *track, TVector3 p, bool &tailToHead, Double_t &extrapolationLength, Double_t rScale)
{
...
int ATTPCHelixTrackFindingTask::CheckParentTrackID(KBTpcHit *hit)
{
...
bool ATTPCHelixTrackFindingTask::CheckTrackQuality(KBHelixTrack *track)
{
  /*
...
double ATTPCHelixTrackFindingTask::CheckTrackContinuity(KBHelixTrack *track)
{
...
bool ATTPCHelixTrackFindingTask::CheckHitDistInAlphaIsLargerThanQuarterPi(KBHelixTrack *track, Double_t dLength)
{
  if (dLength > 0) {
