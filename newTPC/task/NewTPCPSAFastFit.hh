#ifndef NEWTPCPSAFASTFIT_HH
#define NEWTPCPSAFASTFIT_HH
...
class NewTPCPSAFastFit : public NewTPCPSA, public KBPulseGenerator
{
  public:
    NewTPCPSAFastFit();
    NewTPCPSAFastFit(TString fileName);
    virtual ~NewTPCPSAFastFit() {}
